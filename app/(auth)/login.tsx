...
const styles = StyleSheet.create({
  ...
  header: {
    ...
    paddingTop: 48, // approximate for pt-12, usually 48px
  },
  backButton: {
    width: 40,
    height: 40,
  ...
  socialButton: {
    ...
    alignItems: "center",
    justifyContent: "center",
    marginBottom: 12, // to mimic gap for older RN versions if needed, though most recent RN supports gap
  },
  socialButtonText: {
    color: "white",
    marginLeft: 12, // ml-3
